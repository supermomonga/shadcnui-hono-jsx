  ...
  return (
    ...
    >
      <IconPlaceholder
        ...
        className="pointer-events-none absolute top-1/2 lite:icon-inset size-4 -translate-y-1/2 text-muted-foreground"
      />
      <Input
        type={type}
        className={cn(
          "lite:text-inset scheme-light dark:scheme-dark [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-50 [&::-webkit-calendar-picker-indicator]:hover:opacity-100",
          className
        )}
        {...props}
      />
