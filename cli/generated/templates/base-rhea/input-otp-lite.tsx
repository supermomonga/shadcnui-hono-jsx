      ...
      >
        {Array.from({ length: maxLength }, (_, index) => (
          <div
            ...
            class="relative flex size-8 items-center justify-center border-y border-r border-input bg-input/50 text-sm transition-[color,box-shadow] duration-200 outline-none first:rounded-l-2xl first:border-l last:rounded-r-2xl group-has-aria-invalid/input-otp:border-destructive group-has-focus-visible/input-otp:border-ring"
          />
        ))}
      </div>
      {/*
