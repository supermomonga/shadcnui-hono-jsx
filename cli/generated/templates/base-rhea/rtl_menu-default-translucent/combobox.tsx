...
// upstream: shadcn/ui base-rhea/combobox (https://ui.shadcn.com/r/styles/base-rhea/combobox.json)
// upstream-revision: sha256:e0887d9e8e2480c43166f9539c2a503c78c74446117bbf4c70bc96212bb0d27b; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: adapter
...
function ComboboxChip({
  ...
  return (
    <ComboboxChipElement
      ...
      class={cn(
        "flex h-[calc(--spacing(5.25))] w-fit items-center justify-center gap-1 rounded-2xl bg-input px-1.5 text-xs font-medium whitespace-nowrap text-foreground has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pe-0.5 dark:bg-input/60",
        className
      )}
      {...props}
    >
      ...
      {showRemove && (
        <ComboboxChipRemoveElement
          ...
          class="-ms-0.5 size-4.5 opacity-50 hover:opacity-100 aria-disabled:pointer-events-none"
