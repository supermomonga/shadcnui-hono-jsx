...
// upstream: shadcn/ui base-rhea/menubar (https://ui.shadcn.com/r/styles/base-rhea/menubar.json)
// upstream-revision: sha256:e012db9784617dccb21a5b2ac6f556483b6def282afbbeb180ce8528a2682a23; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
...
function Menubar({ class: className, ...props }: MenubarRootProps) {
  return (
    <MenubarRootElement
      data-slot="menubar"
      class={cn("flex h-8 items-center rounded-2xl border p-[3px]", className)}
      {...props}
    />
  )
}
...
function MenubarCheckboxItem({
  ...
  return (
    <MenuCheckboxItemElement
      ...
      data-inset={inset}
      class={cn(
        "relative flex min-h-7 cursor-default items-center gap-2 rounded-xl py-1.5 pe-1.5 ps-7 text-sm outline-hidden select-none focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:ps-7 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      checked={checked}
      {...props}
    >
      <span class="pointer-events-none absolute start-1.5 flex size-4 items-center justify-center [&_svg:not([class*='size-'])]:size-4">
...
function MenubarLabel({
  ...
  return (
    <DropdownMenuLabel
      ...
      data-inset={inset}
      class={cn(
        "px-2 py-1 text-sm text-muted-foreground data-inset:ps-7",
        className
      )}
      {...props}
    />
...
function MenubarSubTrigger({
  ...
  return (
    <DropdownMenuSubTrigger
      ...
      data-inset={inset}
      class={cn(
        "min-h-7 gap-2 rounded-xl px-2 py-1.5 text-sm focus:bg-accent focus:text-accent-foreground data-inset:ps-7 data-open:bg-accent data-open:text-accent-foreground [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
