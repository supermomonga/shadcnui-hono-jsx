...
// variant: rtl
// based-on: shadcn/ui base-rhea/input-otp (https://ui.shadcn.com/r/styles/base-rhea/input-otp.json) sha256:64b61b429c160de441c82f18261b2a95fb2c8c4430a995281c31ae2383eaf618
...
function InputOTPLite({
  ...
  return (
    <div
      ...
      class={cn(
        "group/input-otp relative w-fit flex items-center has-disabled:opacity-50 rounded-2xl has-aria-invalid:ring-3 has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-focus-visible:ring-3 has-focus-visible:ring-ring/30",
        containerClassName
      )}
      style={
        {
      ...
      >
        {Array.from({ length: maxLength }, (_, index) => (
          <div
            ...
            class="relative flex size-8 items-center justify-center border-y border-e border-input bg-input/50 text-sm transition-[color,box-shadow] duration-200 outline-none first:rounded-s-2xl first:border-s last:rounded-e-2xl group-has-aria-invalid/input-otp:border-destructive group-has-focus-visible/input-otp:border-ring"
          />
        ))}
      </div>
      {/*
