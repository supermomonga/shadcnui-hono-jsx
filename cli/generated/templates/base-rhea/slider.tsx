...
// upstream: shadcn/ui base-rhea/slider (https://ui.shadcn.com/r/styles/base-rhea/slider.json)
// upstream-revision: sha256:5011f6d8cd4f8c28008137ebfd9f1210b147f33b9fdf608119d7e2fe0f29d8ea; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
    ...
    >
      <SliderControlElement class="relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">
        <SliderTrackElement
          ...
          class="relative grow overflow-hidden rounded-2xl bg-input/90 select-none data-horizontal:h-1 data-horizontal:w-full data-vertical:h-full data-vertical:w-1"
        >
