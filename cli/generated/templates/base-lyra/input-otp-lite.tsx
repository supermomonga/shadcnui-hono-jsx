      ...
      */}
      <div class="absolute inset-0 overflow-hidden rounded-none">
        <input
          ...
          minlength={maxLength}
          class={cn(
            "h-full w-[calc((var(--input-otp-length)+1)*--spacing(8))] border-0 bg-transparent pb-px pl-[calc((--spacing(8)-1ch)/2)] text-xs tracking-[calc(--spacing(8)-1ch)] text-foreground tabular-nums outline-none disabled:cursor-not-allowed",
            className
          )}
          style={style}
          {...props}
