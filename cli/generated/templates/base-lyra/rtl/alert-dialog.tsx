...
// upstream: shadcn/ui base-lyra/alert-dialog (https://ui.shadcn.com/r/styles/base-lyra/alert-dialog.json)
// upstream-revision: sha256:18a2c4c0bd926e2b870f8b3d9e3eb37c869e221a5601a637a4fe04f90556f195; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPopupElement
        ...
        class={cn(
          ...
          "group/alert-dialog-content fixed top-1/2 start-1/2 z-50 grid w-full -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 gap-4 rounded-none bg-popover p-4 text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none data-[size=default]:max-w-xs data-[size=sm]:max-w-xs data-[size=default]:sm:max-w-sm open:animate-in open:fade-in-0 open:zoom-in-95 not-open:animate-out not-open:fade-out-0 not-open:zoom-out-95 not-open:hidden transition-[display,overlay] transition-discrete",
          className
        )}
        {...props}
      />
