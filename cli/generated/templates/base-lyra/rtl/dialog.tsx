...
// upstream: shadcn/ui base-lyra/dialog (https://ui.shadcn.com/r/styles/base-lyra/dialog.json)
// upstream-revision: sha256:4c56406b86552c7f78442e99f4b97c3edc4d66d0fa0634ec2e7b73cfc9695045; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
...
function DialogHeader({ class: className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      class={cn("flex flex-col gap-1 text-start", className)}
      {...props}
    />
  )
}
