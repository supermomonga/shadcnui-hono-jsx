...
// upstream: shadcn/ui base-lyra/select (https://ui.shadcn.com/r/styles/base-lyra/select.json)
// upstream-revision: sha256:1db07fc67bc996d8da71eab913ceb972ef3eea0c5863fdc0d364282d6e2189ac; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
...
function SelectTrigger({
  ...
  return (
    <SelectTriggerElement
      ...
      data-size={size}
      class={cn(
        "flex w-fit items-center justify-between gap-1.5 rounded-none border border-input bg-transparent py-2 pe-2 ps-2.5 text-xs whitespace-nowrap transition-colors outline-none select-none focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-1 aria-invalid:ring-destructive/20 has-[option[data-placeholder]:checked]:text-muted-foreground data-[size=default]:h-8 data-[size=sm]:h-7 data-[size=sm]:rounded-none **:data-[slot=select-value]:line-clamp-1 **:data-[slot=select-value]:flex **:data-[slot=select-value]:items-center **:data-[slot=select-value]:gap-1.5 dark:bg-input/30 dark:hover:bg-input/50 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
...
function SelectSeparator({ class: className, ...props }: ComponentProps<"hr">) {
  return (
    <hr
      ...
      class={cn("pointer-events-none -mx-1 h-px bg-border border-0", className)}
      {...props}
    />
  )
}
