...
// upstream: shadcn/ui base-lyra/slider (https://ui.shadcn.com/r/styles/base-lyra/slider.json)
// upstream-revision: sha256:b1468470eded307123edd187af219ba13fb8828021bd5772ad0fe0777c0fbb0e; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
    ...
    >
      <SliderControlElement class="relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">
        <SliderTrackElement
          ...
          class="relative grow overflow-hidden rounded-none bg-muted select-none data-horizontal:h-1 data-horizontal:w-full data-vertical:h-full data-vertical:w-1"
        >
