...
// upstream: shadcn/ui base-luma/menubar (https://ui.shadcn.com/r/styles/base-luma/menubar.json)
// upstream-revision: sha256:f8c7515b294fcad685c3ffd2d2a1219c40ed490d79201ecf0d304647e6849435; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
...
function Menubar({ class: className, ...props }: MenubarRootProps) {
  return (
    <MenubarRootElement
      data-slot="menubar"
      class={cn("flex h-9 items-center rounded-3xl border p-1", className)}
      {...props}
    />
  )
}
...
function MenubarCheckboxItem({
  ...
  return (
    <MenuCheckboxItemElement
      ...
      data-inset={inset}
      class={cn(
        "relative flex cursor-default items-center gap-2.5 rounded-2xl py-2 pe-3 ps-9.5 text-sm font-medium outline-hidden select-none focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:ps-9.5 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      checked={checked}
      {...props}
...
function MenubarSubTrigger({
  ...
  return (
    <DropdownMenuSubTrigger
      ...
      data-inset={inset}
      class={cn(
        "gap-2 rounded-2xl px-3 py-2 text-sm font-medium focus:bg-accent focus:text-accent-foreground data-inset:ps-9.5 data-open:bg-accent data-open:text-accent-foreground [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    />
