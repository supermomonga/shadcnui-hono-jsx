// Generated by shadcnui-hono-jsx. DO NOT EDIT; run `bun run generate hover-card`.
// upstream: shadcn/ui base-luma/hover-card (https://ui.shadcn.com/r/styles/base-luma/hover-card.json)
// upstream-revision: sha256:6938b450a47e0fb468e56147a1e4015836346bb03c5b366f496357b828053129; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
...
const HOVER_DEFAULTS = { delay: 600, closeDelay: 300 }

function PreviewCardTriggerElement({
  render,
  style,
  ...props
  ...
  return renderElement(
    <a {...hoverTriggerAttributes(hover, style)} {...props} />,
    render
  )
}

function PreviewCardPopupElement({ style, ...props }: ComponentProps<"div">) {
  const hover = useHoverContext()
...
function HoverCard({ ...props }: HoverRootProps) {
  return <HoverRootElement data-slot="hover-card" {...props} />
}

function HoverCardTrigger({ ...props }: ComponentProps<"a", RenderProp>) {
  return <PreviewCardTriggerElement data-slot="hover-card-trigger" {...props} />
}
...
function HoverCardContent({
  ...
  >) {
  return (
    <HoverPortalElement data-slot="hover-card-portal">
      <AnchorPositioner
        align={align}
