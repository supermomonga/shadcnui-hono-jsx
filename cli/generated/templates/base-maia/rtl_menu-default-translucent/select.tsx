...
// upstream: shadcn/ui base-maia/select (https://ui.shadcn.com/r/styles/base-maia/select.json)
// upstream-revision: sha256:5d87c019f350804ffecc54e2efbc43839dd54cf4d256f52597d13b9eca6051b6; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
...
function SelectTrigger({
  ...
  return (
    <SelectTriggerElement
      ...
      data-size={size}
      class={cn(
        "flex w-fit items-center justify-between gap-1.5 rounded-4xl border border-input bg-input/30 px-3 py-2 text-sm whitespace-nowrap transition-colors outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-[3px] aria-invalid:ring-destructive/20 has-[option[data-placeholder]:checked]:text-muted-foreground data-[size=default]:h-9 data-[size=sm]:h-8 **:data-[slot=select-value]:line-clamp-1 **:data-[slot=select-value]:flex **:data-[slot=select-value]:items-center **:data-[slot=select-value]:gap-1.5 dark:hover:bg-input/50 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
