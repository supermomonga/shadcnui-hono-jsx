...
// upstream: shadcn/ui base-maia/combobox (https://ui.shadcn.com/r/styles/base-maia/combobox.json)
// upstream-revision: sha256:dfa3d6a60e564a8e2365fb8369ca3b946196b4231a7bb96a40fcb10cfdea6462; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: adapter
...
function ComboboxLabel({ class: className, ...props }: ComponentProps<"div">) {
  return (
    <ComboboxGroupLabelElement
      ...
      class={cn("px-3.5 py-2.5 text-xs text-muted-foreground", className)}
      {...props}
    />
  )
}
