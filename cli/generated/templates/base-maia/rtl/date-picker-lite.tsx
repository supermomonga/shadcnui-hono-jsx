...
// variant: rtl
// based-on: shadcn/ui base-maia/calendar (https://ui.shadcn.com/r/styles/base-maia/calendar.json) sha256:b1c6a813aacb7e9c7e4250fbee04739008b589a0bb7171962b0facb1cad89317
// based-on: shadcn/ui base-maia/input (https://ui.shadcn.com/r/styles/base-maia/input.json) sha256:a7818e1843d3fb5ddb13595f3d1f94b4b42b1a766a9f0c2d8603f7f9a59bb4a0
...
function DatePickerLite({
  ...
  return (
    ...
    >
      <CalendarIcon class="pointer-events-none absolute top-1/2 start-3 size-4 -translate-y-1/2 text-muted-foreground" />
      <Input
        type={type}
        class={cn(
          "ps-8.5 scheme-light dark:scheme-dark [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-50 [&::-webkit-calendar-picker-indicator]:hover:opacity-100",
          className
        )}
        {...props}
      />
