...
// upstream: shadcn/ui base-maia/alert-dialog (https://ui.shadcn.com/r/styles/base-maia/alert-dialog.json)
// upstream-revision: sha256:3917274fa0f4b15e69edb56cd59c34f5b0cab595580628c4ade0a59a4f556617; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPopupElement
        ...
        class={cn(
          ...
          "group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-full -translate-x-1/2 -translate-y-1/2 gap-6 rounded-4xl bg-popover p-6 text-popover-foreground ring-1 ring-foreground/5 duration-100 outline-none data-[size=default]:max-w-xs data-[size=sm]:max-w-xs data-[size=default]:sm:max-w-md open:animate-in open:fade-in-0 open:zoom-in-95 not-open:animate-out not-open:fade-out-0 not-open:zoom-out-95 not-open:hidden transition-[display,overlay] transition-discrete",
          className
        )}
        {...props}
      />
