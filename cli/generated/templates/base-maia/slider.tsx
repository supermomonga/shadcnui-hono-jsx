...
// upstream: shadcn/ui base-maia/slider (https://ui.shadcn.com/r/styles/base-maia/slider.json)
// upstream-revision: sha256:1b6e523c93311724df19830cc9368b09c4049f623c0c5a1bd0e7fe2f98156b31; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
    ...
    >
      <SliderControlElement class="relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">
        <SliderTrackElement
          ...
          class="relative grow overflow-hidden rounded-4xl bg-muted select-none data-horizontal:h-3 data-horizontal:w-full data-vertical:h-full data-vertical:w-3"
        >
