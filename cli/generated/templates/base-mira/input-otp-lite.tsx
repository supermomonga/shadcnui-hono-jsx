      ...
      */}
      <div class="absolute inset-0 overflow-hidden rounded-md">
        <input
          ...
          minlength={maxLength}
          class={cn(
            "h-full w-[calc((var(--input-otp-length)+1)*--spacing(7))] border-0 bg-transparent pb-px pl-[calc((--spacing(7)-1ch)/2)] text-xs/relaxed tracking-[calc(--spacing(7)-1ch)] text-foreground tabular-nums outline-none disabled:cursor-not-allowed",
            className
          )}
          style={style}
          {...props}
