// Generated by shadcnui-hono-jsx. DO NOT EDIT; run `bun run generate dropdown-menu`.
// upstream: shadcn/ui base-mira/dropdown-menu (https://ui.shadcn.com/r/styles/base-mira/dropdown-menu.json)
// upstream-revision: sha256:fe15008359b49083b880bafdd40cc4eb6b8ff0a932825b4f8b9c32a3f913bfda; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
...
const LABELLED_BY_TRIGGER = true
...
function DropdownMenu({ ...props }: MenuRootProps) {
  return <MenuRootElement data-slot="dropdown-menu" {...props} />
}

function DropdownMenuPortal({ ...props }: { children?: Child }) {
  return <MenuPortalElement data-slot="dropdown-menu-portal" {...props} />
}

function DropdownMenuTrigger({
  ...props
}: ComponentProps<"button", RenderProp>) {
  return <MenuTriggerElement data-slot="dropdown-menu-trigger" {...props} />
}
...
function DropdownMenuGroup({ ...props }: ComponentProps<"div">) {
  return <MenuGroupElement data-slot="dropdown-menu-group" {...props} />
}
...
function DropdownMenuSub({ ...props }: MenuRootProps) {
  return <MenuSubmenuRootElement data-slot="dropdown-menu-sub" {...props} />
}
...
function DropdownMenuRadioGroup({ ...props }: MenuRadioGroupProps) {
  return (
    <MenuRadioGroupElement data-slot="dropdown-menu-radio-group" {...props} />
  )
}
