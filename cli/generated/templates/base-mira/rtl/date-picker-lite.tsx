...
function DatePickerLite({
  ...
  return (
    ...
    >
      <CalendarIcon class="pointer-events-none absolute top-1/2 start-2 size-4 -translate-y-1/2 text-muted-foreground" />
      <Input
        type={type}
        class={cn(
          "ps-7.5 scheme-light dark:scheme-dark [&::-webkit-calendar-picker-indicator]:cursor-pointer [&::-webkit-calendar-picker-indicator]:opacity-50 [&::-webkit-calendar-picker-indicator]:hover:opacity-100",
          className
        )}
        {...props}
      />
