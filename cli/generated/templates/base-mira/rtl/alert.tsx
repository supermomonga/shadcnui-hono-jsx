...
// upstream: shadcn/ui base-mira/alert (https://ui.shadcn.com/r/styles/base-mira/alert.json)
// upstream-revision: sha256:1dd315153e3ec76639fceff0f57b570153d3451cf1a9df47edffdfc29feb201e; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
...
function AlertAction({ class: className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      class={cn("absolute top-1.5 end-2", className)}
      {...props}
    />
  )
}
