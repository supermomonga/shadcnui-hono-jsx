...
// upstream: shadcn/ui base-mira/alert-dialog (https://ui.shadcn.com/r/styles/base-mira/alert-dialog.json)
// upstream-revision: sha256:48ba01cfe7ad7702b5c804a61205d5e4bdce5b06d535b3ec7aa79151cc8d167c; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPopupElement
        ...
        class={cn(
          ...
          "backdrop:bg-black/80 backdrop:duration-100 supports-backdrop-filter:backdrop:backdrop-blur-xs open:backdrop:animate-in open:backdrop:fade-in-0 not-open:backdrop:animate-out not-open:backdrop:fade-out-0",
          "group/alert-dialog-content fixed top-1/2 start-1/2 z-50 grid w-full -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 gap-3 rounded-xl bg-popover p-4 text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none data-[size=default]:max-w-xs data-[size=sm]:max-w-64 data-[size=default]:sm:max-w-sm open:animate-in open:fade-in-0 open:zoom-in-95 not-open:animate-out not-open:fade-out-0 not-open:zoom-out-95 not-open:hidden transition-[display,overlay] transition-discrete",
          className
        )}
        {...props}
      />
