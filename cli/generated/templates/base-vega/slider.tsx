...
// upstream: shadcn/ui base-vega/slider (https://ui.shadcn.com/r/styles/base-vega/slider.json)
// upstream-revision: sha256:84aec4c238a96d3b4b41d81af88e1887c79677d4a824505a17e7b0b0c1626afc; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
    ...
    >
      <SliderControlElement class="relative flex w-full touch-none items-center select-none data-disabled:opacity-50 data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col">
        <SliderTrackElement
          ...
          class="relative grow overflow-hidden rounded-full bg-muted select-none data-horizontal:h-1.5 data-horizontal:w-full data-vertical:h-full data-vertical:w-1.5"
        >
