...
// upstream: shadcn/ui base-vega/dialog (https://ui.shadcn.com/r/styles/base-vega/dialog.json)
// upstream-revision: sha256:6f2c99f3497cb6882343a8457988f2343a317c08249e1436620b20269fcc0032; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
    ...
    <DialogPortal>
      ...
      <DialogPopupElement
        ...
        class={cn(
          ...
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-6 rounded-xl bg-popover p-6 text-sm text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none sm:max-w-md open:animate-in open:fade-in-0 open:zoom-in-95 not-open:animate-out not-open:fade-out-0 not-open:zoom-out-95 not-open:hidden transition-[display,overlay] transition-discrete",
          className
        )}
        {...props}
      >
...
function DialogTitle({ class: className, ...props }: ComponentProps<"h2">) {
  return (
    <DialogTitleElement
      ...
      class={cn("font-heading leading-none font-medium", className)}
      {...props}
    />
  )
}
