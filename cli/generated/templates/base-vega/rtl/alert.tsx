...
// upstream: shadcn/ui base-vega/alert (https://ui.shadcn.com/r/styles/base-vega/alert.json)
// upstream-revision: sha256:0b2c3f7ac31f5b1e46df82ba60ce4cf796bea2a4ea914a2d791b0c5f7e331cad; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
...
function AlertAction({ class: className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      class={cn("absolute top-2.5 end-3", className)}
      {...props}
    />
  )
}
