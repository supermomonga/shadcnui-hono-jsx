...
// upstream: shadcn/ui base-vega/alert-dialog (https://ui.shadcn.com/r/styles/base-vega/alert-dialog.json)
// upstream-revision: sha256:d4daaf4b1335afaed13c903507ca0742a8ea020bae8fa72e12d7413aaaa772ed; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPopupElement
        ...
        class={cn(
          ...
          "group/alert-dialog-content fixed top-1/2 start-1/2 z-50 grid w-full -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 gap-6 rounded-xl bg-popover p-6 text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none data-[size=default]:max-w-xs data-[size=sm]:max-w-xs data-[size=default]:sm:max-w-lg open:animate-in open:fade-in-0 open:zoom-in-95 not-open:animate-out not-open:fade-out-0 not-open:zoom-out-95 not-open:hidden transition-[display,overlay] transition-discrete",
          className
        )}
        {...props}
      />
