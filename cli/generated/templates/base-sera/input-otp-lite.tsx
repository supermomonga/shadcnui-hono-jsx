      ...
      */}
      <div class="absolute inset-0 overflow-hidden rounded-none">
        <input
          ...
          minlength={maxLength}
          class={cn(
            "absolute top-0 start-0 h-full w-[calc((var(--input-otp-length)+1)*--spacing(11))] border-0 bg-transparent pb-px pl-[calc((--spacing(10)-1ch)/2)] text-sm tracking-[calc(--spacing(11)-1ch)] text-foreground tabular-nums outline-none disabled:cursor-not-allowed rtl:[unicode-bidi:bidi-override] rtl:translate-x-[calc(--spacing(11)-1ch)]",
            className
          )}
          style={style}
          {...props}
