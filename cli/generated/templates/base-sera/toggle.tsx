...
// upstream: shadcn/ui base-sera/toggle (https://ui.shadcn.com/r/styles/base-sera/toggle.json)
// upstream-revision: sha256:8055d9da3fb3905ce60c85424aaad5d66ee4c1bda162e145fca82a18d5a56636; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
...
const toggleVariants = cva(
  "group/toggle inline-flex items-center justify-center gap-1.5 rounded-none text-xs font-semibold tracking-widest whitespace-nowrap uppercase transition-colors outline-none hover:bg-muted hover:text-foreground has-focus-visible:border-ring has-focus-visible:ring-[3px] has-focus-visible:ring-ring/30 has-disabled:pointer-events-none has-disabled:opacity-50 has-aria-invalid:border-destructive has-aria-invalid:ring-destructive/20 has-checked:bg-muted dark:has-aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
  {
    variants: {
      variant: {
