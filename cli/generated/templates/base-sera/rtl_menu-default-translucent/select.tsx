...
// upstream: shadcn/ui base-sera/select (https://ui.shadcn.com/r/styles/base-sera/select.json)
// upstream-revision: sha256:2b2653de964455754088617db02b9b2bdff83e97e51a541a1cf3c9997d900dad; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
...
function SelectTrigger({
  ...
  return (
    <SelectTriggerElement
      ...
      data-size={size}
      class={cn(
        "flex w-fit items-center justify-between gap-1.5 rounded-none border border-transparent border-b-input bg-transparent px-0 py-2 text-sm whitespace-nowrap transition-[color,border-color] outline-none focus-visible:border-b-ring disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-b-destructive has-[option[data-placeholder]:checked]:text-muted-foreground data-[size=default]:h-10 data-[size=sm]:h-9 **:data-[slot=select-value]:line-clamp-1 **:data-[slot=select-value]:flex **:data-[slot=select-value]:items-center **:data-[slot=select-value]:gap-1.5 dark:aria-invalid:border-b-destructive/50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
        className
      )}
      {...props}
    >
...
function SelectSeparator({ class: className, ...props }: ComponentProps<"hr">) {
  return (
    <hr
      ...
      class={cn(
        "pointer-events-none -mx-1.5 my-1.5 h-px bg-border/50 border-0",
        className
      )}
      {...props}
    />
