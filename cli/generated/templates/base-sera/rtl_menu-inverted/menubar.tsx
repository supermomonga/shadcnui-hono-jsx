...
// upstream: shadcn/ui base-sera/menubar (https://ui.shadcn.com/r/styles/base-sera/menubar.json)
// upstream-revision: sha256:9903b548a5fea216149da0c3b68c409e868efb7fcbc035f606db6371b089ebba; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
...
function Menubar({ class: className, ...props }: MenubarRootProps) {
  return (
    <MenubarRootElement
      data-slot="menubar"
      class={cn("flex h-10 items-center rounded-none border p-1", className)}
      {...props}
    />
  )
}
...
function MenubarCheckboxItem({
  ...
  return (
    <MenuCheckboxItemElement
      ...
      data-inset={inset}
      class={cn(
        "relative flex cursor-default items-center gap-2.5 rounded-none py-2 pe-3 ps-9.5 text-xs font-medium tracking-wider uppercase outline-hidden select-none focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:ps-9.5 data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      checked={checked}
      {...props}
    >
      <span class="pointer-events-none absolute start-3 flex size-4 items-center justify-center [&_svg:not([class*='size-'])]:size-4">
...
function MenubarLabel({
  ...
  return (
    <DropdownMenuLabel
      ...
      data-inset={inset}
      class={cn(
        "px-3.5 py-2 text-xs font-semibold tracking-wider text-muted-foreground uppercase data-inset:ps-9.5",
        className
      )}
      {...props}
    />
...
function MenubarSubTrigger({
  ...
  return (
    <DropdownMenuSubTrigger
      ...
      data-inset={inset}
      class={cn(
        "gap-2 rounded-none px-3 py-2 text-xs font-medium tracking-wider uppercase focus:bg-accent focus:text-accent-foreground data-inset:ps-9.5 data-open:bg-accent data-open:text-accent-foreground [&_svg:not([class*='size-'])]:size-3.5",
        className
      )}
      {...props}
    />
