...
// upstream: shadcn/ui base-sera/table (https://ui.shadcn.com/r/styles/base-sera/table.json)
// upstream-revision: sha256:c7e0dc15dbfa995d93d398b03ce14ce282a9a3a88233d231e15a08268d12139f; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
...
function TableHead({ class: className, ...props }: ComponentProps<"th">) {
  return (
    <th
      ...
      class={cn(
        "h-12 px-3 text-start align-middle text-xs font-medium tracking-wider whitespace-nowrap text-muted-foreground uppercase [&:has([data-slot=checkbox])]:pe-0",
        className
      )}
      {...props}
    />
...
function TableCell({ class: className, ...props }: ComponentProps<"td">) {
  return (
    <td
      ...
      class={cn(
        "p-3 align-middle whitespace-nowrap [&:has([data-slot=checkbox])]:pe-0",
        className
      )}
      {...props}
    />
