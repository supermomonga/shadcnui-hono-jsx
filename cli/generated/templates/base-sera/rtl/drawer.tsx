...
// upstream: shadcn/ui base-sera/drawer (https://ui.shadcn.com/r/styles/base-sera/drawer.json)
// upstream-revision: sha256:5f0456b7e6e38fb82ac8aab4410f6192f4b1be698fe295f4a42fea194f7e6ac9; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
    ...
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPopupElement
        ...
        class={cn(
          ...
          "backdrop:min-h-dvh backdrop:bg-black/20 backdrop:opacity-[max(var(--drawer-overlay-min-opacity,0),calc(1-var(--drawer-swipe-progress)))] backdrop:transition-opacity backdrop:duration-450 backdrop:ease-[cubic-bezier(0.32,0.72,0,1)] backdrop:select-none not-open:backdrop:pointer-events-none not-open:backdrop:opacity-0 not-open:backdrop:duration-[calc(var(--drawer-swipe-strength)*400ms)] data-snap-points:backdrop:[--drawer-overlay-min-opacity:0.5] starting:backdrop:opacity-0 data-swiping:backdrop:duration-0 supports-backdrop-filter:backdrop:backdrop-blur-sm",
          "group/drawer-popup pointer-events-auto fixed z-50 m-(--drawer-inset,0px) flex h-(--drawer-content-height) max-h-(--drawer-content-max-height,none) min-h-0 w-(--drawer-content-width,auto) transform-[translate3d(var(--translate-x,0px),var(--translate-y,0px),0)_scale(var(--stack-scale))] flex-col bg-popover text-sm text-popover-foreground transition-[transform,height,opacity,filter,display,overlay] duration-450 ease-[cubic-bezier(0.22,1,0.36,1)] will-change-transform outline-none select-none [interpolate-size:allow-keywords] data-[swipe-direction=down]:rounded-none data-[swipe-direction=down]:border-t data-[swipe-direction=left]:rounded-none data-[swipe-direction=left]:border-e data-[swipe-direction=right]:rounded-none data-[swipe-direction=right]:border-s data-[swipe-direction=up]:rounded-none data-[swipe-direction=up]:border-b not-open:hidden transition-discrete",
          // Nested.
...
function DrawerHeader({ class: className, ...props }: ComponentProps<"div">) {
  return (
    <div
      ...
      class={cn(
        "flex shrink-0 flex-col gap-1 p-4 pb-0 group-data-[swipe-axis=y]/drawer-popup:text-center md:gap-2 md:text-start",
        className
      )}
      {...props}
    />
