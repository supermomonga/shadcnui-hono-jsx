...
// upstream: shadcn/ui base-sera/dialog (https://ui.shadcn.com/r/styles/base-sera/dialog.json)
// upstream-revision: sha256:6fc5ca41001f6185d4f5b40788f108a80d946f1b61f5448125f290ced292fcaa; shadcn-ui/ui@98a1fe67b439324ddc857f47fbdce056600a4329
// mode: generated
// variant: rtl
    ...
    <DialogPortal>
      ...
      <DialogPopupElement
        ...
        class={cn(
          ...
          "backdrop:bg-black/20 backdrop:duration-100 supports-backdrop-filter:backdrop:backdrop-blur-sm open:backdrop:animate-in open:backdrop:fade-in-0 not-open:backdrop:animate-out not-open:backdrop:fade-out-0",
          "fixed top-1/2 start-1/2 z-50 grid w-full max-w-[calc(100%-2rem)] -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1/2 gap-6 rounded-none bg-popover p-6 text-sm text-popover-foreground shadow-md ring-1 ring-foreground/10 duration-100 outline-none sm:max-w-md open:animate-in open:fade-in-0 open:zoom-in-95 not-open:animate-out not-open:fade-out-0 not-open:zoom-out-95 not-open:hidden transition-[display,overlay] transition-discrete",
          className
        )}
        {...props}
      >
        ...
        {showCloseButton && (
          <DialogCloseElement
            ...
            render={
              <Button
                variant="ghost"
                class="absolute top-5 end-5 bg-secondary"
                size="icon-sm"
              />
            }
          >
