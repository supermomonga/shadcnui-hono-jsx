...
export function buildThemeCss(theme: ThemeItem, source: ThemeHeader): string {
  ...
  const sections = [
    header([
      ...
      `Derived from shadcn/ui, Copyright (c) 2023 shadcn, MIT License. See https://github.com/${source.repository}/blob/main/THIRD_PARTY_LICENSES.md`,
      "",
...
export function buildVendoredTailwindCss(
  ...
  return `${header([
    ...
    `Copyright (c) 2023 shadcn, MIT License. See https://github.com/${source.repository}/blob/main/THIRD_PARTY_LICENSES.md`,
  ])}\n\n${text}`
}
